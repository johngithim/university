...
ALTER TABLE "borrow_records" ADD CONSTRAINT "borrow_records_id_books_id_fk" FOREIGN KEY ("id") REFERENCES "public"."books"("id") ON DELETE no action ON UPDATE no action;